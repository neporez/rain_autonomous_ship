...
#include "det_msgs/msg/detail/clustered_detected_objects__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.new_bbox_check;
  }
  // Member: id
  {
    cdr << ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  // Member: new_bbox_check
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.new_bbox_check[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: id
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = det_msgs::msg::ClusteredDetectedObjects;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const det_msgs::msg::ClusteredDetectedObjects *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<det_msgs::msg::ClusteredDetectedObjects *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ClusteredDetectedObjects__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const det_msgs::msg::ClusteredDetectedObjects *>(
...
static size_t _ClusteredDetectedObjects__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ClusteredDetectedObjects(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ClusteredDetectedObjects__callbacks = {
  "det_msgs::msg",
...
static rosidl_message_type_support_t _ClusteredDetectedObjects__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ClusteredDetectedObjects__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_det_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<det_msgs::msg::ClusteredDetectedObjects>()
{
  return &det_msgs::msg::typesupport_fastrtps_cpp::_ClusteredDetectedObjects__handle;
}
