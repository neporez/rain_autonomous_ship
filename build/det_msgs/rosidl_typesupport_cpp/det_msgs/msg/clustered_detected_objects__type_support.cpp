...
static const _ClusteredDetectedObjects_type_support_symbol_names_t _ClusteredDetectedObjects_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, det_msgs, msg, ClusteredDetectedObjects)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, det_msgs, msg, ClusteredDetectedObjects)),
  }
};
...
{
  return &::det_msgs::msg::rosidl_typesupport_cpp::ClusteredDetectedObjects_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, det_msgs, msg, ClusteredDetectedObjects)() {
  return get_message_type_support_handle<det_msgs::msg::ClusteredDetectedObjects>();
}
